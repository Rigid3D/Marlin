...
void Endstops::M119() {
  ...
  #define ES_REPORT(AXIS) do{ \
    ...
    SERIAL_PROTOCOLPGM(MSG_TOOLHEAD_SENSOR0);
    SERIAL_PROTOCOLLN(((READ(TCE_T0_PIN)^TCE_T0_ENDSTOP_INVERTING) ? MSG_ENDSTOP_HIT : MSG_ENDSTOP_OPEN));
    SERIAL_PROTOCOLPGM(MSG_TOOLHEAD_SENSOR1);
    SERIAL_PROTOCOLLN(((READ(TCE_T1_PIN)^TCE_T1_ENDSTOP_INVERTING) ? MSG_ENDSTOP_HIT : MSG_ENDSTOP_OPEN));    
  #endif  
} // Endstops::M119
